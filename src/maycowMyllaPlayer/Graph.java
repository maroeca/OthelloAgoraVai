...
public class Graph {
    ...
    public void setupGraph(int[][] tab, int player, int depth, int maxDepth) {
        setStartNode(tab);
        simulateStates(tab, startNode, player, 1, maxDepth);
    }
    ...
    /**
     * Heuristicas e funçoes auxiliares.
